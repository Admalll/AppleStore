...
final class ItemWebViewViewController: UIViewController {
    ...
    private func setupWebView() {
        ...
        switch itemName {
        case "Чехол Incase Flat для MacBook pro 16 дюймов":
            setupUrl(string: Const.caseGray)
        case "Спортивный ремешок Black Unity (для к...":
            setupUrl(string: Const.belt)
        case "Кожаный чехол для MacBook Pro 16 дюймов, золотой":
            setupUrl(string: Const.caseBrown)
        case "iPhone 12 Pro Max 256 GB":
...
extension ItemWebViewViewController: WKUIDelegate { }
